...
- Abstract base classes + constructor injection for testability (`IngestionClientBase`, `IngestionEngineBase`, `IngestionProducerBase`, `UniqueTrackerBase` - see `ingestion/ports.py`) - follow this shape for new components instead of hard-wiring dependencies.
